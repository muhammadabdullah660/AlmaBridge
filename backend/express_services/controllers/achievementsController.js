...
const createAchievement = async (req, res) => {
    try {
        const { achievementName, achieverName, achieverCategory, achievementsDescription, session, department } = req.body;
        ...
        if (req.file) {
            newAchievement.achieverPicture = req.file.path.replace(/\\/g, '/');
        }
