      ...
      <div>
        ...
        <header className="bg-[#0F0F0F] text-white text-center py-32">
          ...
          <div className="mt-10 flex justify-center inputdiv">
            ...
            <button className="bg-teal-600 px-6 py-2 text-white notifbutton">
              Notify Me
            </button>
          </div>
        </header>
        ...
        <div className="text-container highlight-text-container">
          <h1 className="highlight-text">
            ...
            <span className="highlight"> potential</span> of the alumni
            community by fostering <span className="highlight">meaningful</span>{" "}
            <span className="highlight">connections </span>
            between <span className="highlight">graduates </span> and{" "}
            <span className="highlight">current students </span>
          </h1>
        </div>
            ...
            <details className="border-gray-200 group">
              ...
              <div className="p-4 group-open:bg-[#333333] group-open:text-white">
                <p>
                  ...
                  into a Pro plan at your existing rate. If you were on a Small
                  Team plan, then all 5 seats have been converted over to Pro
                  seats at your existing rate. Regardless of your subscription
                  plan, all new paid editors that you add to your subscription
                  will be billed at the new plan rates.
                </p>
              </div>
            </details>
              ...
              <div className="banner">
                <div className="banner-content">
                  <div className="banner-para">
                    <h1 className="text-3xl md:text-2xl sm:text-xl">
