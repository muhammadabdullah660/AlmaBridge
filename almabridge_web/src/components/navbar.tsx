            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
                ...
                <div className="hidden md:flex space-x-4 items-center">
                    <Link href="#signin" legacyBehavior>
                        <a className="text-[#00BDD6] font-bold text-sm lg:text-base transition-colors duration-300">Sign in</a>
                    </Link>
            ...
            <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`}>
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <div className="px-3 py-2">
                        <Link href="#signin" legacyBehavior>
                            <a className="block px-3 py-2 rounded-md text-base font-medium text-[#00BDD6] font-bold">Sign in</a>
                        </Link>
                        <Link href="#signup" legacyBehavior>
                            <a className="block px-3 py-2 rounded-md text-base font-medium text-[#00BDD6] font-bold">Sign up</a>
                        </Link>
