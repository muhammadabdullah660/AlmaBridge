...
const {getUserProfile, updateUserProfile, getAllUserProfiles} = require('../controllers/userProfileController');
...
router.post('/profile', limiter, upload.single('resume'), verifyToken, updateUserProfile);
